...
SchData$raz <- raz <- factor(km3$cluster, levels=c(2, 1, 3), labels=c("univerzalisti", "podpovprečno odprti", "podpovprečno konservativni"))
# Velikost skupin
velikost <- table(raz)
```
...
```{r, fig.cap="Spremenljivke Nadzor glede na razvrstitev v skupine"}
