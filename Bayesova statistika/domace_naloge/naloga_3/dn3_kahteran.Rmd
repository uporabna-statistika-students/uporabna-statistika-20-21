...
Podobno kot za $\mu_j$, zgleda da smo dosegli konvergenco. _Burn-in_ ravno tako ni opazen v nobenem izmed izbranih primerov in ravno tako kot pri $\mu_j$, smo tudi tu določili začetne vrednosti variance, kar vzorčne variance posameznih skupin. Največ kar opazimo je to da je varianca v skupinah $2$ in $8$ večja kot v skupinah $9$ in $42$ (Večja razpršenost pri enaki $y$-skali). Zopet si poglejmo če bomo _burn-in_ opazili pri prvih 500 členih zaporedja.
...
Ravno tako opazimo razlike med posameznimi skupinami. Če mogoče ni bilo opazno na _trace plot_-ih je tu precej bolje videti da so porazdelitve nekoliko asimetrične. To je tudi smiselno saj jih vzorčimo z inverzno gamma porazdelitvijo, ki je ravno tako asimetrična. Poglejmo si še podvzorce za hiperparametre.
...
Večjih težav z avtokorelacijo pri $\mu_j$ in $\sigma_j^2$, ni videti. Pri hiperparametrih vidimo da gre pri vseh parametrih korelacija kasneje k $0$, kot bi si želeli. Smiselno si je pogledati še _effective sample size_ vseh parametrov. Zraven je dodana še "standardna napaka" (MCSE - Monte Carlo Standard Error).
...
# 4. shrinkage povprecja in varianco kot v 3.3.1 iz navodil. kratki komentarji
...
5. Primerjajte rezultate obeh hierarhicnih modelov. Ali so rezultati za (hiper)parametre,
ki opisujejo povprecja podobni? Razmislite, ali je uporaba splosnejsega hierarhicnega
modela z razlicnimi variancami skupin potrebna pri teh podatkih? Oziroma, kdaj bi
bila bolj potrebna in kdaj manj?
