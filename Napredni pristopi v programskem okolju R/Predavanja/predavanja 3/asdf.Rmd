...
maxgrip.MO <- matrix(NA, ncol=7, nrow=nrow(ES.data.wide))




for(i in 1:num.waves)
  maxgrip.MO[,i] <- cbind.data.frame(select(ES.data.wide, starts_with("maxgrip")), maxgrip.MO)[cbind(seq_along(ES.data.wide$first.wave), ES.data.wide$first.wave+i-1)]
